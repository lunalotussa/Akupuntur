...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2021 at 07:13 PM
...
INSERT INTO `terapis` (`id_terapis`, `id_user`, `alamat`, `telepon`, `bank`, `unit_bank`, `no_rekening`, `ktp`, `selfie_ktp`, `profile`, `pdf`, `status`) VALUES
(2, 3, 'Jl. Hasanudin No 10 Batu', 2147483647, 'Mandiri', 'Ngagglik-Batu1', 2147483647, '797bac3009b11e35171982c6356323f1.jpg', 'khs_sem_3.PNG', 'pbo1.PNG', 'SK_Pra_TA_Mahasiswa_Prodi_TI_-Victoria.pdf', '1'),
...
(5, 9, 'Jl. Danau Rinjani 8B', 2147483647, 'Mandiri', 'Sawojajar-Malang', 4567890, '', '', '', 'Pengantar_TA_an__Victoria_Luna.pdf', '1'),
(7, 12, '', 0, '', '', 0, '', '', '', '', '1'),
(8, 16, '', 0, '', '', 0, '', '', '', '', '');
...
(15, 'cc', 'cece@gmail.com', 'b4ea23a368b20bc1623e058f392f1fe4', 'Customer'),
(16, 'ggg', 'gaby12@gmail.com', 'ba248c985ace94863880921d8900c53f', 'Terapis');
...
--
ALTER TABLE `terapis`
  MODIFY `id_terapis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
