...
<head>
  ...
  <!-- STYLESHEETS -->
  <link href="assets/relish/css/bootstrap.css" rel="stylesheet" type="text/css" />
  <link rel="stylesheet" href="assets/relish/font-awesome/css/font-awesome.min.css" />
  <link href="assets/relish/css/vertical.min.css" rel="stylesheet" type="text/css" />
  <link href="assets/relish/css/magnific-popup.css" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" type="text/css" href="assets/relish/revslider/css/settings.css" media="screen" />
  <link href="assets/relish/css/styles.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div class="page" id="top">
    ...
    <div class="tp-banner-container">
        ...
        <ul>
          ...
          <li data-masterspeed="700">
            ...
            <div class="tp-caption sl-content font-alt" data-x="['right']" data-hoffset="20" data-y="['75']" data-voffset="0" data-width="['315px','250px','200px','150px']" data-height="['315px','250px','200px','150px']" data-transform_in="opacity:0;s:1000;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:1000;" data-start="400">
              ...
              <div class="img-line">
                <img src="assets/relish/images/lines/img-line-8.png" data-at2x="assets/relish/images/lines/img-line-8@2x.png" alt />
              </div>
      ...
      <div class="slider-rect-bot">
        <img src="assets/relish/images/lines/rectangle-2.png" data-at2x="assets/relish/images/lines/rectangle-2@2x.png" alt />
      </div>
    </div>
    ...
    <section class="small-section alt-color" id="jasa">
      <div class="container align-center">
        <h3 class="section-title bottom-line font-alt">
          Pelayanan Untuk Anda<span>Perpaduan Sempurna antara Teknik & Relaksasi</span>
        </h3>
          ...
          <div class="slider-1 dots-alt">
            ...
            <div class="shop-container align-center alt-2">
              ...
              <a href="shop-single-item.html">
                <h3 class="shop-title font-alt">Ayurvedic Spa</h3>
              </a>
  ...
  <script type="text/javascript" src="assets/relish/revslider/js/jquery.themepunch.tools.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/jquery.themepunch.revolution.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/jquery.themepunch.tools.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/jquery.themepunch.revolution.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.slideanims.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.layeranimation.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.navigation.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.parallax.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.video.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.actions.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.kenburn.min.js"></script>
  <script type="text/javascript" src="assets/relish/revslider/js/extensions/revolution.extension.migration.min.js"></script>
  <script type="text/javascript" src="assets/relish/http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
