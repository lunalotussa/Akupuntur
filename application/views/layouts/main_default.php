            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<!-- <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Data Admin</span>
                            </a>
					...
					<!-- 	<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Customer</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
						...
						<!-- <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Detail Transaksi</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('detail_transaksi/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('detail_transaksi/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li> -->
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('layanan/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('layanan/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
                        <li>
						...
						<!-- <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Terapis</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('terapi/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('terapi/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li> -->
                        <li>
						...
						<!-- <li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('transaksi/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('transaksi/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li> -->
						<!-- <li>
