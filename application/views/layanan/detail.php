                    ...
                    <div class="col-md-6">
                        ...
                        <?php
                            ...
                            $sql1 ="SELECT * from detail_layanan WHERE id_terapis=$id_terapis";
                                ...
                                //$detail_id_layanan = $row1->id_layanan;
                        ?>
                        <label>
                        <input type="checkbox" class="custom-control-input" name="layanan[]" value="<?=$id_layanan;?>" <?php 
                         foreach($query1->result() as $row1){
                        ...
                        <!-- <input type="checkbox" class="custom-control-input" name="layanan[]" value="<?=$id_layanan;?>" <?php 
                        if($id_layanan == $detail_id_layanan) echo "checked = 'checked'"; ?>> <?=$jenis;?> - <?=$nama;?> - <?=$durasi;?> - Rp.<?=$harga;?>,- -->
                       </label><br>
                      <?php
                        }}}?>
                        </div>
